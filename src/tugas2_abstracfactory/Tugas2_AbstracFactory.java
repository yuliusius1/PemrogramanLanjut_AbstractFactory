...
public class Tugas2_AbstracFactory {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<namaMinuman.length;i++){
            Minuman minuman1 = minuman.getMinuman(namaMinuman[i],jnsMinuman[i],jmlMinuman[i]);
            System.out.println(minuman1.getJumlahMinuman()+ " " + minuman1.getJenisMinuman()+ " " + minuman1.getNamaMinuman()+ " \t\t= Rp." + minuman1.getHargaMinuman());
